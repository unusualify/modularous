...
Full cache facade for Modularous — handles tag-based caching, TTL management, and targeted cache invalidation scoped to modules and route names. See [ModularousCacheService](/system-reference/backend/services/modularous-cache-service) for implementation details.
