---
sidebarPos: 8
sidebarTitle: Modularous
---

# Modularous

**Facade**: `Unusualify\Modularous\Facades\Modularous`  
**Accessor**: `modularous`  
**Underlying**: `Unusualify\Modularous\Modularous`
...
// Check availability
if (Modularous::hasModule('Payment')) {
    // payment features available
}

// Iterate all enabled modules
foreach (Modularous::getEnabledModules() as $module) {
    echo $module->getName();
}
```
