...
| [ModularityRoutes](./modularity-routes) | `Support` | Defines route group options and registers all middleware aliases |
| [ModularityVite](./modularity-vite) | `Support` | Extends Laravel `Vite` for Modularous asset manifest |
