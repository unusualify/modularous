...
**Contract**: `Unusualify\Modularity\Contracts\CurrencyProviderInterface`
...
```php
// config/modularity.php (merged from packages/modularous/config/merges/services.php)
'services' => [
    'currency_exchange' => [
...
$this->app->bind(
    \Unusualify\Modularity\Contracts\CurrencyProviderInterface::class,
