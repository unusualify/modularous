...
Modularous serves most of the functionalities over traits. See [File Storage with Filepond](/guide/generics/file-storage-with-filepond) for the full implementation guide.
