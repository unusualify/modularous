...
| Command | Description |
|---------|-------------|
| [modularous:operations:process](/guide/console/operations/process-operations) | Dispatch or run pending module operations |
| [modularous:publish:operations](/guide/console/operations/publish-operations) | Publish the operations vendor assets |
...
- [`modularous:make:operation`](../generators/make-operation) — scaffold a new operation class
