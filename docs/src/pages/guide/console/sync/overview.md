...
|---------|-----------|-------------|
| [sync:states](./sync-states) | `modularity:sync:states` | Sync model state values to their current definitions |
| [sync:translations](./sync-translations) | `modularity:sync:translations` | Sync translation keys across all registered locales |
