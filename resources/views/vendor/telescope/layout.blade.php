...
@include("modularity::partials.icons.svg-sprite")
...
<div id="telescope" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-stretch py-4 header">
            ...
            <a class="btn btn-primary d-inline-flex align-items-center" href="{{ route('admin.dashboard') }}" title="Back to Panel">
                <svg style="width: 20px; height: 25px;"><use xlink:href="#icon--main-logo-dark"></use></svg>
            </a>
        </div>
