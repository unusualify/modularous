...
return [
    ...
    | - 'Unusualify\Modularous\Services\FileLibrary\Disk'
    |
     */
    'disk' => modularousBaseKey() . '_file_library',
    ...
    'file_service' => env('FILE_LIBRARY_FILE_SERVICE', 'Unusualify\Modularous\Services\FileLibrary\Disk'),
