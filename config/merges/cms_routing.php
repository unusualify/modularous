...
return [
     ...
     */
    'localization_driver' => env('MODULARITY_CMS_LOCALIZATION_DRIVER', 'auto'),
     ...
     */
    'public_front_route_group_mode' => env('MODULARITY_CMS_PUBLIC_FRONT_ROUTE_GROUP_MODE', 'catch_all'),

    /**
     * When {@see public_front_route_group_mode} is {@code locale_param}, append {@code LaravelLocalizationRoutes}.
     */
    'public_front_mcamara_middleware_with_locale_param' => env('MODULARITY_CMS_PUBLIC_FRONT_MCAMARA_MW_LOCALE_PARAM', true),

    /**
     * When using {@code catch_all}, optionally append mcamara {@code LaravelLocalizationRoutes} (usually false).
     */
    'public_front_mcamara_middleware_with_catch_all' => env('MODULARITY_CMS_PUBLIC_FRONT_MCAMARA_MW_CATCH_ALL', false),
     ...
     */
    'localization_hide_default_source' => env('MODULARITY_CMS_LOCALIZATION_HIDE_DEFAULT_SOURCE', 'mcamara'),

    'locale_strategy' => env('MODULARITY_CMS_LOCALE_STRATEGY', 'path'),
    'canonical_host' => env('MODULARITY_CMS_CANONICAL_HOST', parse_url((string) env('APP_URL', ''), PHP_URL_HOST)),
    'default_locale' => env('MODULARITY_CMS_DEFAULT_LOCALE', env('APP_LOCALE', 'en')),
    'hide_default_locale_segment' => env('MODULARITY_CMS_HIDE_DEFAULT_LOCALE_SEGMENT', false),
     ...
     */
    'fallback_locale_optional_path_segment' => env('MODULARITY_CMS_FALLBACK_LOCALE_OPTIONAL_PATH_SEGMENT', false),
     ...
     */
    'fallback_locale_optional_path_segment_locale' => env('MODULARITY_CMS_FALLBACK_LOCALE_OPTIONAL_LOCALE') ?: null,
    ...
    'fallback_locale_explicit_segment_redirect_status' => max(
        301,
        min(308, (int) env('MODULARITY_CMS_FALLBACK_LOCALE_EXPLICIT_SEGMENT_REDIRECT_STATUS', 301)),
    ),
    'domain_per_locale' => [
        // Example: 'en' => 'example.com', 'tr' => 'example.com.tr'
    ],
    'redirect_to_canonical' => env('MODULARITY_CMS_REDIRECT_TO_CANONICAL', false),
     ...
     */
    'public_front_route_domain' => env('MODULARITY_CMS_PUBLIC_FRONT_ROUTE_DOMAIN'),
     ...
     *
     * Env: {@code MODULARITY_CMS_PUBLIC_FRONT_ROUTES_ALLOW_ANY_HOST}
     */
    'public_front_routes_allow_any_host' => env('MODULARITY_CMS_PUBLIC_FRONT_ROUTES_ALLOW_ANY_HOST', false),
     ...
     */
    'bind_public_routes_to_app_url_host' => env('MODULARITY_CMS_BIND_PUBLIC_ROUTES_TO_APP_URL_HOST'),
    ...
    'front_route_prefix' => env('MODULARITY_CMS_FRONT_ROUTE_PREFIX', ''),
    ...
    'public_pages_enabled' => env('MODULARITY_CMS_PUBLIC_PAGES_ENABLED', true),
     ...
     */
    'auto_register_public_front' => env('MODULARITY_CMS_AUTO_REGISTER_PUBLIC_FRONT', true),
     ...
     * target with {@link \Unusualify\Modularity\Entities\Traits\HasParentSegment}. When false, the first
     ...
     */
    'universal_cms_public_front' => env('MODULARITY_CMS_UNIVERSAL_PUBLIC_FRONT', true),
     ...
     * {@see \Unusualify\Modularity\Module::getTargetClassNamespace()} with {@code front-controller} + {@code {StudlyRoute}Controller}.
    ...
    'visitor_redirects_enabled' => env('MODULARITY_CMS_VISITOR_REDIRECTS_ENABLED', true),

    /**
     * Admin panel (slug validation, path preview).
     *
     * @see \Modules\Cms\Services\CmsSlugInputValidationService
     * @see \Unusualify\Modularity\Hydrates\Inputs\SlugHydrate
     */
    'admin' => [
        'slug_nested_path_warnings' => env('MODULARITY_CMS_ADMIN_SLUG_NESTED_WARNINGS', true),
        'slug_public_path_preview' => env('MODULARITY_CMS_ADMIN_SLUG_PUBLIC_PATH_PREVIEW', true),
        /**
         ...
         * @see \Modules\Cms\Services\CmsSlugInputValidationService
         */
        'slug_max_path_segments' => env('MODULARITY_CMS_ADMIN_SLUG_MAX_PATH_SEGMENTS') !== null
            && env('MODULARITY_CMS_ADMIN_SLUG_MAX_PATH_SEGMENTS') !== ''
            ? max(1, (int) env('MODULARITY_CMS_ADMIN_SLUG_MAX_PATH_SEGMENTS'))
            : null,
    ],
     ...
     */
    'resync_registry_after_parent_segments_change' => env('MODULARITY_CMS_RESYNC_URL_ROUTES_AFTER_PARENT_SEGMENTS_CHANGE', true),

    /**
     * Batch size when walking models after parent-segment edits (Slug / IsSingular targets only).
     */
    'parent_segment_change_resync_chunk_size' => max(1, (int) env('MODULARITY_CMS_PARENT_SEGMENT_RESYNC_CHUNK', 100)),
     ...
     */
    'signed_preview' => [
        'enabled' => env('MODULARITY_CMS_SIGNED_PREVIEW_ENABLED', true),
        'path_prefix' => trim((string) env('MODULARITY_CMS_SIGNED_PREVIEW_PATH_PREFIX', 'cms/preview'), '/'),
        'ttl_minutes' => max(5, (int) env('MODULARITY_CMS_SIGNED_PREVIEW_TTL_MINUTES', 60)),
        /** Laravel throttle: max attempts per decay minutes (per IP) for the signed preview route. */
        'throttle_max_attempts' => max(1, (int) env('MODULARITY_CMS_SIGNED_PREVIEW_THROTTLE_MAX', 120)),
        'throttle_decay_minutes' => max(1, (int) env('MODULARITY_CMS_SIGNED_PREVIEW_THROTTLE_DECAY', 1)),
    ],
];
