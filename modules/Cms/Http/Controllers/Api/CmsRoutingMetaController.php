...
class CmsRoutingMetaController extends Controller
{
    public function __invoke(
        ...
        return response()->json([
            'front_route_prefix' => trim((string) modularityConfig('cms_routing.front_route_prefix', 'cms'), '/'),
            ...
            'locale_strategy' => (string) modularityConfig('cms_routing.locale_strategy', 'path'),
            'public_front_route_group_mode' => (string) modularityConfig('cms_routing.public_front_route_group_mode', 'catch_all'),
            ...
            'admin' => [
                'slug_nested_path_warnings' => (bool) modularityConfig('cms_routing.admin.slug_nested_path_warnings', true),
                'slug_public_path_preview' => (bool) modularityConfig('cms_routing.admin.slug_public_path_preview', true),
                'slug_max_path_segments' => modularityConfig('cms_routing.admin.slug_max_path_segments'),
                'signed_preview_enabled' => (bool) modularityConfig('cms_routing.signed_preview.enabled', true),
                'signed_preview_ttl_minutes' => max(5, (int) modularityConfig('cms_routing.signed_preview.ttl_minutes', 60)),
            ],
