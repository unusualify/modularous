...
return new class extends Migration
{
    public function up()
    {
        $countryTable = modularousConfig('tables.countries', 'um_countries');
        $countryTranslationTable = modularousConfig('tables.country_translations', 'um_country_translations');
