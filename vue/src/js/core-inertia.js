...
createInertiaApp({
    ...
    setup({ el, App, props, plugin }) {
      ...
      console.debug('[modularous]: inertia setup')

      if(__HAS_ZIGGY__){
        console.debug('[modularous]: found on vendor/tightenco/ziggy')
        app.use(ZiggyVue)
      } else {
        console.debug('[modularous]: no found on vendor/tightenco/ziggy')
      }
      app.use(UEConfig)
