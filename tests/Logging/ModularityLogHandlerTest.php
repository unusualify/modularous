...
namespace Unusualify\Modularity\Tests\Logging;
...
class ModularityLogHandlerTest extends TestCase
{
    ...
    {
        $handler = new ModularityLogHandler(Level::Warning, 30);
    ...
    public function it_generates_daily_log_path_with_current_date()
    {
        ...
        $this->assertStringContainsString('modularity-' . $expectedDate . '.log', $path);
    ...
    public function it_writes_debug_level_logs_to_file()
    {
        ...
        $logFile = $logsDir . '/modularity-' . date('Y-m-d') . '.log';
    ...
    public function it_rotates_old_log_files_when_exceeding_max_files()
    {
        ...
        for ($i = 0; $i < 5; $i++) {
            ...
            $file = $logDir . "/modularity-{$date}.log";
        ...
        $handler = new ModularityLogHandler(Level::Debug, 3);
        ...
        $remainingFiles = glob($logDir . '/modularity-*.log');
    ...
    public function it_formats_log_message_correctly()
    {
        ...
        $this->assertStringContainsString('modularity', $contents);
