...
use Unusualify\Modularity\Support\ModularityRoutes;
use Unusualify\Modularity\Tests\TestCase;

class ModularityRoutesTest extends TestCase
{
    protected ModularityRoutes $routes;

    protected function setUp(): void
    {
        parent::setUp();
        $this->routes = new ModularityRoutes;
    }
    ...
    public function test_web_middlewares_returns_array()
    {
        ...
        $this->assertContains('modularity.log', $middlewares);
    }
    ...
    public function test_web_panel_middlewares_includes_auth_and_panel()
    {
        ...
        $this->assertContains('modularity.panel', $middlewares);
    }
    ...
    {
        Config::set('modularity.api.prefix', 'api/v1');
    ...
    {
        Config::set('modularity.api.domain', null);
    ...
    {
        Modularity::shouldReceive('getAdminRouteNamePrefix')->andReturn('admin');
        Modularity::shouldReceive('hasAdminAppUrl')->andReturn(false);
        Modularity::shouldReceive('getAdminUrlPrefix')->andReturn('admin');
        Modularity::shouldReceive('getAppUrl')->andReturn('http://localhost');
        Modularity::shouldReceive('getAdminAppHost')->andReturn(null);
    ...
    {
        Config::set('modularity.route_patterns', ['id' => '[0-9]+']);
    ...
    {
        Config::set('modularity.route_patterns', null);
