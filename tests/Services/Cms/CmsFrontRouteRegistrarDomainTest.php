...
class CmsFrontRouteRegistrarDomainTest extends TestCase
{
    ...
    public function test_resolve_public_front_route_domain_legacy_bind_true_uses_app_url_host(): void
    {
        ...
        $this->app['config']->set('modularous.cms_routing.public_front_route_domain', null);
        $this->app['config']->set('modularous.cms_routing.public_front_routes_allow_any_host', false);
        $this->app['config']->set('modularous.cms_routing.bind_public_routes_to_app_url_host', true);
    ...
    public function test_resolve_public_front_route_domain_allow_any_host_true_overrides_explicit_bind(): void
    {
        $this->app['config']->set('app.url', 'http://frontend.b2press.test');
        $this->app['config']->set('modularous.cms_routing.public_front_route_domain', null);
        $this->app['config']->set('modularous.cms_routing.public_front_routes_allow_any_host', true);
        $this->app['config']->set('modularous.cms_routing.bind_public_routes_to_app_url_host', true);
    ...
    public function test_resolve_public_front_route_domain_respects_explicit_config(): void
    {
        ...
        $this->app['config']->set('modularous.cms_routing.public_front_route_domain', 'cms.example.test');
