...
class CmsPublicSiteUrlTest extends TestCase
{
    ...
    {
        $this->app['config']->set('modularity.cms_routing.public_front_route_domain', 'frontend.example.test');
    ...
    {
        $this->app['config']->set('modularity.cms_routing.public_front_route_domain', 'a.test');
        $this->app['config']->set('modularity.cms_routing.canonical_host', 'b.test');
    ...
    public function test_absolute_url_falls_back_to_url_helper_when_no_host_resolved(): void
    {
        ...
        $this->app['config']->set('modularity.cms_routing.canonical_host', '');
