...
class CmsSlugPathSegmentPolicyTest extends TestCase
{
    ...
    {
        $this->app['config']->set('modularity.cms_routing.admin.slug_max_path_segments', null);
    ...
    {
        $this->app['config']->set('modularity.cms_routing.admin.slug_max_path_segments', 1);
    ...
    {
        $this->app['config']->set('modularity.cms_routing.admin.slug_max_path_segments', 2);
