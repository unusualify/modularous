...
class CmsFrontPathPublicBrowserPathTest extends TestCase
{
    ...
    {
        $this->app['config']->set('modularity.cms_routing.front_route_prefix', 'cms');
        $this->app['config']->set('modularity.cms_routing.default_locale', 'en');
        $this->app['config']->set('modularity.cms_routing.hide_default_locale_segment', false);
    ...
    public function test_public_browser_path_hides_default_locale_segment_when_configured(): void
    {
        $this->app['config']->set('modularity.cms_routing.front_route_prefix', 'cms');
        $this->app['config']->set('modularity.cms_routing.default_locale', 'en');
        $this->app['config']->set('modularity.cms_routing.hide_default_locale_segment', true);
    ...
    public function test_public_browser_path_omits_slugless_fallback_locale_segment_when_toggle_on(): void
    {
        ...
        $this->app['config']->set('modularity.cms_routing.fallback_locale_optional_path_segment_locale', 'en');
