...
| ---        | ---              | ---     | ---  | ---     |
| 0.x        | 8.1 - 8.3        | 10      | >=18 | 3       |
| 10.x       | 8.1 - 8.3        | 10      | >=18 | 3       |
| 11.x       | 8.2 - 8.4        | 11      | >=20 | 3       |
| 12.x       | 8.2 - 8.5        | 12      | >=20 | 3       |
</div>
...
The Modularous toolkit is open-sourced software licensed under the [MIT license](https://opensource.org/licenses/MIT).
