...
class InstallCommand extends BaseCommand
{
    ...
    private function checkDbConnection(): void
    {
        ...
        if (! database_exists()) {
            ...
            $answer = $this->choice('Database does not exist. Do you want to create it?', ['y', 'n'], 'n');
            ...
            if (! database_exists()) {
                warning('Could not connect to the database after creation. Please check your configuration.' . "\n");
