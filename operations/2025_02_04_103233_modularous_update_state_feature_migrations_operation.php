...
return new class extends OneTimeOperation
{
    ...
    public function process(): void
    {
        ...
        DB::table('migrations')
            ...
            ->update(['migration' => '2024_10_22_093258_create_modularous_stateable_tables']);
        ...
        if (! Schema::hasTable($stateTable)) {
            ...
            if ($stateTableExists && $stateTranslationsTableExists && $stateablesTableExists && confirm('Do you want to rename the states, state_translations and stateables tables to ' . $stateTable . ', ' . $stateTranslationsTable . ' and ' . $stateablesTable . '?')) {
                ...
                Artisan::call('migrate', [
                    '--path' => Modularous::getVendorPath('database/migrations/default/2024_10_22_093258_create_modularous_stateable_tables.php'),
                ]);
        ...
        $this->output->writeln('Modularous: Update State Feature Migrations operation processed');
    }
};
