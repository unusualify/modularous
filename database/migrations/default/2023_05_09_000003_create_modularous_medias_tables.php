...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        $mediasTable = modularousConfig('tables.medias', 'um_medias');
        ...
        if (! Schema::hasTable($mediablesTable)) {
            Schema::create($mediablesTable, function (Blueprint $table) use ($mediasTable) {
                ...
                $table->timestamps();
                $table->softDeletes();
                $table->{modularousIntegerMethod()}('mediable_id')->nullable()->unsigned();
                $table->string('mediable_type')->nullable();
                $table->{modularousIntegerMethod()}('media_id')->unsigned();
