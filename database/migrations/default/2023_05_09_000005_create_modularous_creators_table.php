...
return new class extends Migration
{
    ...
    public function up()
    {
        $creatorRecordsTable = modularousConfig('tables.creator_records', 'um_creator_records');
    ...
    {
        $creatorRecordsTable = modularousConfig('tables.creator_records', 'modularous_creator_records');
